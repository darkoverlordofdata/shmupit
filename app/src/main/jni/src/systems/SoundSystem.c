/** updated by adriac */
/* SoundSystem.c generated by valac 0.36.4-dirty, the Vala compiler
 * generated from SoundSystem.vala, do not modify */

/*[Adriac:Systems::SoundSystem:SystemsSoundSystem:systems_sound_system]*/
...
static void __lambda135_ (Block37Data* _data37_, gfloat delta);
...
static void __lambda136_ (SystemsSoundSystem* self, EntitasEntity* entity);
gboolean entitas_entity_IsActive (EntitasEntity *self);
void sdx_audio_sound_Play (SdxAudioSound* self, gint loops);
static void ___lambda136__gfunc (gconstpointer data, gpointer self);
static void ___lambda135__entitas_system_execute (gfloat delta, gpointer self);
...
static void block37_data_unref (void * _userdata_) {
	...
	if (g_atomic_int_dec_and_test (&_data37_->_ref_count_)) {
		SystemsSoundSystem* self;
		self = _data37_->self;
		_entitas_group_release0 (_data37_->effects);
...
static void ___lambda136__gfunc (gconstpointer data, gpointer self) {
	__lambda136_ ((SystemsSoundSystem*) self, data);
}
...
static void __lambda135_ (Block37Data* _data37_, gfloat delta) {
	...
	GList* _tmp0_;
	self = _data37_->self;
	_tmp0_ = _data37_->effects->entities;
	g_list_foreach (_tmp0_, ___lambda136__gfunc, self);
}


static void ___lambda135__entitas_system_execute (gfloat delta, gpointer self) {
	__lambda135_ (self, delta);
}
...
SystemsSoundSystem* systems_sound_system_new (Game* game, Factory* world) {
	...
	((EntitasSystem*) self)->Execute = ___lambda135__entitas_system_execute;
